...
public class StickerContentProvider extends ContentProvider {
    ...
    /**
     * Do not change the strings listed below, as these are used by WhatsApp. And changing these will break the interface between stickers app and WhatsApp.
     */
    ...
    public boolean onCreate() {
        ...
        //the call to get the metadata for the stickers packs.
        MATCHER.addURI(authority, METADATA, METADATA_CODE);

        //the call to get the metadata for single stickers pack. * represent the identifier
        MATCHER.addURI(authority, METADATA + "/*", METADATA_CODE_FOR_SINGLE_PACK);

        //gets the list of stickers for a stickers pack, * respresent the identifier.
